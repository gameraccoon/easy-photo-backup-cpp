...
namespace Noise::NoiseIK
{
	using namespace Cryptography;

	inline const char* ProtocolName = "Noise_IK_25519_ChaChaPoly_BLAKE2b";
	...
	// message 1
	const size_t Message1ExpectedSize = DHLEN + DHLEN + CipherAuthDataSize;
