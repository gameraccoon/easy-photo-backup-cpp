...
namespace Requests
{
	...
	std::optional<PendingClientBinding> processPairingInteractiveRequest(std::span<const std::byte> firstMessage, const Network::RawSocket socket)
	{
